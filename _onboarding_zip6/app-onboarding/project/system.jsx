...
// Inline now-playing row — for the Live Activity card + island (always dark).
function LiveMusicRow({ primary, compact = false }) {
  return (
    <div style={{ display:'flex', alignItems:'center', gap:10 }}>
      {/* album art */}
      <div style={{ width: compact?28:32, height: compact?28:32, borderRadius:7, flexShrink:0,
        background:`linear-gradient(135deg, ${primary}, #7B5Cff)`,
      ...
      <div style={{ flex:1, minWidth:0 }}>
        <div style={{ display:'flex', alignItems:'center', gap:5 }}>
          <SpotifyGlyph size={11} color="#1DB954"/>
          <span style={{ fontFamily:F_SANS, fontSize:13, fontWeight:600, color:'#fff',
            whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis' }}>Power</span>
        </div>
        <div style={{ fontFamily:F_SANS, fontSize:11, color:'rgba(255,255,255,0.55)',
          whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis', marginTop:1 }}>Kanye West</div>
      </div>
      {/* pause + skip */}
      <div style={{ display:'flex', alignItems:'center', gap:2, flexShrink:0 }}>
        <div style={{ width:30, height:30, borderRadius:15, display:'flex',
    ...
    <SpringboardBase t={t} dim>
      <div style={{ position:'absolute', top:11, left:'50%', transform:'translateX(-50%)',
        ...
        <div style={{
          ...
          {/* music — same activity, in parallel */}
